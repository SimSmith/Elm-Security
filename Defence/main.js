...
var _user$project$FML$nodding = A3(
	_elm_lang$html$Html$node,
	'script',
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('alert(\'Hi\');'),
		_1: {ctor: '[]'}
	});
var _user$project$FML$formMe = A2(
	_elm_lang$html$Html$form,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$action('javascript:alert(\'ok\')'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$FML$linkAtMe = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href('javascript:alert()'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$FML$innerSoul = A2(
	_elm_lang$html$Html$div,
	{
		...
		_0: A2(
			_elm_lang$html$Html_Attributes$property,
			'innerHTML',
			_elm_lang$core$Json_Encode$string('<img onerror=\'alert()\' src=\'x.y\'/>')),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$FML$objectsAreFine = A2(
	_elm_lang$html$Html$object,
	{
		...
		_0: A2(
			_elm_lang$html$Html_Attributes$property,
			'data',
			_elm_lang$core$Json_Encode$string('data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==')),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$FML$niceSVG = A2(
	_elm_lang$svg$Svg$svg,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$svg$Svg$script,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$type_('text/javascript'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text('alert(\'ok\')'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$FML$image = A2(
	_elm_lang$html$Html$img,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'onmouseover', 'alert();'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src('colorpicker.gif'),
			_1: {ctor: '[]'}
		}
	},
	{ctor: '[]'});

var _user$project$Main$bStyle = function (_p0) {
...
var _user$project$Main$Node = {ctor: 'Node'};
var _user$project$Main$Form = {ctor: 'Form'};
var _user$project$Main$Link = {ctor: 'Link'};
var _user$project$Main$Inner = {ctor: 'Inner'};
var _user$project$Main$Obj = {ctor: 'Obj'};
var _user$project$Main$SVG = {ctor: 'SVG'};
var _user$project$Main$Image = {ctor: 'Image'};
var _user$project$Main$viewer = function (external) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_user$project$Main$buildButton, _user$project$Main$Image, 'Image'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$buildButton, _user$project$Main$SVG, 'SVG script'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$buildButton, _user$project$Main$Obj, 'Object'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$buildButton, _user$project$Main$Inner, 'innerHTML'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$buildButton, _user$project$Main$Link, 'a, you there!'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$buildButton, _user$project$Main$Form, 'Form'),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$buildButton, _user$project$Main$Node, 'Script Node'),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
...
var _user$project$Main$view = function (model) {
	...
	switch (_p1.ctor) {
		case 'None':
			return _user$project$Main$viewer(
				_elm_lang$html$Html$text('Nothing here.'));
		case 'Image':
			return _user$project$Main$viewer(_user$project$FML$image);
		case 'SVG':
			return _user$project$Main$viewer(_user$project$FML$niceSVG);
		case 'Obj':
			return _user$project$Main$viewer(_user$project$FML$linkAtMe);
		case 'Inner':
			return _user$project$Main$viewer(_user$project$FML$innerSoul);
		case 'Link':
			return _user$project$Main$viewer(_user$project$FML$linkAtMe);
		case 'Form':
			return _user$project$Main$viewer(_user$project$FML$formMe);
		default:
			return _user$project$Main$viewer(_user$project$FML$nodding);
	}
};
var _user$project$Main$None = {ctor: 'None'};
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Main$None, view: _user$project$Main$view, update: _user$project$Main$update})();
